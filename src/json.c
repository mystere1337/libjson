...
/**
 * Enumerates types of JSON values
 */
...
/**
 * Enumerates types of tokens used by the lexer
 */
...
/**
 * Enumerates types of containers that can be used as root
 */
 ...
 */
void json_free(json_container_t* con) {
...
/**
 * Creates a new configuration object, creates necessary file with default object if the specified file doesn't exist.
